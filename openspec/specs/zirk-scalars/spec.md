...
Every arithmetic operation on an integer type, of any width and signedness, SHALL produce a controlled runtime error if the result is not representable in that width, instead of silently wrapping.
