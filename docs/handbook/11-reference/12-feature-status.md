...
| scalar and text families | defined | Phase 3b complete for its scope | `Float128` Windows verification; `Float128` formatting truncates to `Float64` (lossy) |
